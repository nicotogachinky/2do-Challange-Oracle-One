/* Variables */
            ...
            function letraHistorial(letra,x,y){
                ...
                ctx.fillText(letra, x, y);  // aqui ponemos la frase en nuestro caso la variable pista , seguido de la posx y posy
            }
            ...
            function selecciona(e){
                ...
                if (i < teclas_array.length){
                    ...
                    if (bandera == false){ /* Si falla aumenta los errores y checa si perdio para mandar a la funcion gameover */
                         errores++;
                         letraHistorial(tecla.letra,20*errores,20);
